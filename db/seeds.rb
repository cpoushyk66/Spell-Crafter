...
spell_1_hematite_ingredient = Ingredient.create(spell_id: spell1.id, component_id: hematite.id, quantitiy: "Small stone", purpose: "Helps the spell ground you to yourself.", instructions: "")
